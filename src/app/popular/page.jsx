...
export default function page() {
    ...
    const farm = products2.map(products =>(
        <section key={products.id} className='bg-gray-200 w-[80%] h-[100%] rounded-lg  '>
        <Image src={products.images} alt='pics' width={100} height={100} className='mx-auto mt-5'></Image>
  ...
  return (
    ...
    <div className='grid grid-cols-4 gap-5 w-[80%] mx-auto'>{farm}</div>
